...
import { type User, type InsertUser, type AdminUser, type InsertAdminUser, type SiteConfig, type InsertSiteConfig, type Testimonial, type InsertTestimonial, type FaqItem, type InsertFaqItem, type Service, type InsertService, type PhotoCarousel, type InsertPhotoCarousel } from "@shared/schema";
import { db } from "./db";
import { users, adminUsers, siteConfig, testimonials, faqItems, services, photoCarousel } from "@shared/schema";
